# ⚖️ PactFlow Dispute Resolution System

This document details the architecture, on-chain logic, and administrative procedures for resolving conflicts between Companies and Workers within the PactFlow protocol.
...
2.  **Evidence Collection**:
    ...
    - Both parties can submit additional context/reasons via the PactFlow UI (stored in Firestore).
3.  **Mediation**:
