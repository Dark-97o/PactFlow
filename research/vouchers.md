...
## Overview
This document outlines the implementation of the PactFlow Redeem Shop, where workers and companies can utilize their accumulated RPT (Reputation Tokens) to acquire premium vouchers and gift cards.
...
- **Non-Destructive spending**: Spending RPT for vouchers **does not** reduce the on-chain RPT score or lower the user's Trust Tier. It only consumes "Redeemable Balance" tracked in the PactFlow database.
