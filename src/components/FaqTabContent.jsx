  ...
  return (
    <div className="luxury-panel" style={{ padding: '40px', borderLeft: `4px solid ${color}` }}>
      <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr', gap: '50px' }}>
        {/* Left: Steps */}
        <div>
          <h3 style={{ fontSize: '1rem', color: '#fff', marginBottom: '30px', textTransform: 'uppercase', letterSpacing: '2px', display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
            {content.steps.map((step, i) => (
              <div key={i} style={{ display: 'flex', gap: '20px' }}>
                ...
                <div>
                  <h4 style={{ fontSize: '0.9rem', color: '#fff', marginBottom: '8px' }}>{step.title}</h4>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
          ...
          <div style={{ background: 'rgba(255,255,255,0.02)', padding: '25px', border: '1px solid rgba(255,255,255,0.05)' }}>
            <h3 style={{ fontSize: '0.8rem', color: '#fff', marginBottom: '20px', textTransform: 'uppercase', letterSpacing: '1.5px', display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <div style={{ marginTop: 'auto', padding: '15px', border: '1px dashed rgba(255,255,255,0.1)', textAlign: 'center' }}>
            ...
            <div style={{ fontSize: '0.8rem', color: 'rgba(255,255,255,0.2)', textTransform: 'uppercase', letterSpacing: '1px' }}>
