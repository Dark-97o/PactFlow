          ...
          {loading ? (
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr', gap: '40px', alignItems: 'start' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
                <div>
                  <h1 style={{ fontSize: '2.2rem', fontWeight: '900', textTransform: 'uppercase', marginBottom: '15px', lineHeight: '1', color: '#fff' }}>{job.title}</h1>
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: '25px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      <DollarSign size={16} color="var(--primary)" />
                      <span style={{ fontSize: '1.2rem', fontWeight: 'bold', color: '#fff' }}>{job.budget} XLM</span>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: 'var(--text-dim)', fontSize: '0.85rem' }}>
                      <Calendar size={16} />
                      <span>Deadline: <span style={{ color: '#fff' }}>{job.deadline || 'N/A'}</span></span>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: 'var(--text-dim)', fontSize: '0.85rem' }}>
                      <Shield size={16} />
                ...
                <div style={{ padding: '25px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)', borderLeft: '3px solid var(--primary)' }}>
                  ...
                  <p style={{ fontSize: '0.95rem', color: 'rgba(255,255,255,0.8)', lineHeight: '1.7', whiteSpace: 'pre-wrap' }}>{job.description}</p>
                </div>
                ...
                <div style={{ padding: '15px 20px', background: 'rgba(0,0,0,0.3)', border: '1px solid rgba(255,255,255,0.05)', display: 'flex', gap: '40px' }}>
                  <div>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: '0.85rem', fontFamily: 'monospace', color: '#fff' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '25px' }}>
                ...
                <div style={{ padding: '25px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '20px' }}>
                    ...
                    <div>
                      <div style={{ fontSize: '1.1rem', fontWeight: '900', color: '#fff' }}>{companyName}</div>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                    {companyEmail && <div style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '0.8rem', color: 'rgba(255,255,255,0.8)' }}><Mail size={14} color="var(--primary)" /> {companyEmail}</div>}
                    {companyLocation && <div style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '0.8rem', color: 'rgba(255,255,255,0.8)' }}><MapPin size={14} color="var(--primary)" /> {companyLocation}</div>}
                    {companyWebsite && (
