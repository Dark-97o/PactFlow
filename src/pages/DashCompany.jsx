        ...
        <form onSubmit={handlePostJob} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          <div className="input-group">
            ...
            <input 
              ...
              style={{ width: '100%', background: '#0a0a0a', border: '1px solid var(--border-ghost)', padding: '16px', color: '#fff', marginTop: '5px', outline: 'none', fontSize: '1.05rem' }} 
            />
          </div>
          ...
          <div className="input-group">
            ...
            <textarea 
              ...
              style={{ width: '100%', background: '#0a0a0a', border: '1px solid var(--border-ghost)', padding: '16px', color: '#fff', marginTop: '5px', minHeight: '100px', outline: 'none', resize: 'none', fontSize: '1.05rem' }} 
            />
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
            <div className="input-group">
              ...
              <input 
                ...
                style={{ width: '100%', background: '#0a0a0a', border: '1px solid var(--border-ghost)', padding: '16px', color: '#fff', marginTop: '5px', outline: 'none' }} 
              />
            </div>
            <div className="input-group">
            ...
            <div style={{ 
              ...
              <div style={{ flex: 1, cursor: 'pointer' }} onClick={() => setSelectedJobId(job.id)}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '17px' }}>
                  <h3 style={{ fontSize: '1.2rem', margin: 0, fontWeight: '800', color: '#fff', letterSpacing: '0.5px' }}>{job.title}</h3>
                  <div style={{ 
                    padding: '3px 12px', 
                    fontSize: '0.75rem', 
                ...
                <div style={{ display: 'flex', gap: '20px', marginTop: '10px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '11px', fontSize: '0.85rem', color: 'var(--text-dim)' }}>
                    ...
                    <span>ID: <span style={{ color: '#fff', fontFamily: 'monospace' }}>{job.onChainId}</span></span>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '11px', fontSize: '0.85rem', color: 'var(--text-dim)' }}>
                  ...
                  {job.deadline && (
                    <div style={{ display: 'flex', alignItems: 'center', gap: '11px', fontSize: '0.85rem', color: 'var(--text-dim)' }}>
                      ...
                      <span>DEADLINE: <span style={{ color: '#fff' }}>{job.deadline}</span></span>
                    </div>
                  )}
                </div>
              </div>
                            ...
                            <div style={{ display: 'flex', gap: '25px' }}>
                              <div style={{ position: 'relative' }}>
                                  <img 
                                    ...
                                    alt="Worker" 
                                    style={{ width: '45px', height: '45px', borderRadius: '4px', border: '1px solid var(--border-ghost)', objectFit: 'cover', background: '#000' }} 
                                  />
                                <div style={{ 
                                  position: 'absolute', 
                                  bottom: '-4px', 
                              ...
                              <div>
                                <div style={{ fontSize: '1rem', fontWeight: '900', color: '#fff', textTransform: 'uppercase' }}>{app.workerName || 'Anonymous Executor'}</div>
                                ...
                                <div style={{ display: 'flex', gap: '15px', marginTop: '8px' }}>
                                  <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                                    ...
                                    <span style={{ fontSize: '0.8rem', color: '#fff', fontWeight: 'bold' }}>{app.workerExperience || 0}y</span>
                                  </div>
                                  <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                      <div style={{ position: 'relative' }}>
                        <img 
                          ...
                          alt="Worker" 
                          style={{ width: '50px', height: '50px', borderRadius: '4px', border: '1px solid rgba(0, 255, 136, 0.4)', background: '#000' }} 
                        />
                      ...
                      <div>
                        <div style={{ fontSize: '0.9rem', color: '#fff', fontFamily: 'monospace', fontWeight: 'bold' }}>{job.workerAddress}</div>
    ...
    <div style={{ padding: '19px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '25px' }}>
        <div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginTop: '5px' }}>
            ...
            <span style={{ fontSize: '0.9rem', color: '#fff', fontWeight: 'bold', fontFamily: 'monospace' }}>RPT SCORE: {stats.rpt || 0}</span>
          </div>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '20px', marginBottom: '20px' }}>
        <div className="cyber-card" style={{ padding: '25px', background: 'rgba(255,255,255,0.02)', borderLeft: `4px solid ${repInfo.currentTier.color}` }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
            ...
            <span style={{ fontSize: '0.9rem', color: '#fff', fontFamily: 'monospace', fontWeight: '900' }}>{repInfo.progress.toFixed(0)}%</span>
          </div>
        ...
        <div className="cyber-card" style={{ padding: '20px', background: 'linear-gradient(135deg, rgba(0,212,255,0.05) 0%, rgba(0,0,0,0) 100%)', border: '1px solid rgba(0,212,255,0.1)' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
              ...
              <div style={{ fontSize: '1.4rem', fontWeight: 'bold', color: '#fff' }}>{stats.rpt || 0} <span style={{ fontSize: '0.9rem', color: '#00d4ff' }}>Tokens</span></div>
            </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '20px' }}>
        ...
        <div className="cyber-card" style={{ padding: '19px', background: 'rgba(255,255,255,0.01)' }}>
          ...
          <div style={{ fontSize: '1.1rem', fontWeight: 'bold', color: '#fff', marginTop: '5px' }}>{stats.active}</div>
        </div>
        ...
        <form onSubmit={handleUpdateProfile} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '17px' }}>
            ...
            <div className="input-group">
              ...
              <input 
                ...
                style={{ width: '100%', background: '#0a0a0a', border: '1px solid var(--border-ghost)', padding: '14px', color: '#fff', fontSize: '0.95rem', marginTop: '4px' }} 
              />
            </div>
          </div>
          ...
          <div style={{ padding: '19px', background: 'rgba(255,68,68,0.03)', border: '1px solid rgba(255,68,68,0.1)', borderRadius: '8px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: '15px' }}>
              <input type="password" placeholder="New Admin Access Key" style={{ width: '100%', background: '#0a0a0a', border: '1px solid var(--border-ghost)', padding: '12px', color: '#fff', fontSize: '0.9rem' }} />
  ...
  return (
    <DashboardLayout role="company" activeTab={activeTab} onTabChange={setActiveTab}>
      <div style={{ padding: '20px 0' }}>
        ...
        {activeTab === 'nft_shop' && <NFTShop role="company" />}
          ...
          <div style={{ background: '#0d0d0d', border: '1px solid rgba(255,68,68,0.3)', padding: '40px', maxWidth: '560px', width: '90%', position: 'relative' }}>
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              <textarea
                ...
                style={{ width: '100%', background: '#080808', border: '1px solid rgba(255,68,68,0.3)', padding: '16px', color: '#fff', fontSize: '1rem', minHeight: '120px', resize: 'none', outline: 'none', fontFamily: 'inherit', lineHeight: '1.6' }}
              />
            </div>
