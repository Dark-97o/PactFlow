    ...
    <div style={{ color: '#fff' }}>
        ...
        <div style={{ display: 'flex', gap: '30px' }}>
          ...
          <button 
            ...
            style={{ 
              ...
              color: '#fff', padding: '0 20px', cursor: 'pointer', display: 'flex', 
          ...
          <div key={item.id} className="cyber-card" style={{ 
            ...
            <div style={{ 
              ...
              <div style={{ 
                ...
                fontSize: '0.55rem', color: '#fff', textTransform: 'uppercase', 
                letterSpacing: '1px', zIndex: 3, background: 'rgba(0,0,0,0.6)', 
            ...
            <div style={{ padding: '15px', flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
              <div style={{ marginBottom: '15px' }}>
                <div style={{ fontSize: '1.1rem', fontWeight: '900', color: '#fff', letterSpacing: '0.5px' }}>{item.value}</div>
              ...
              <div style={{ 
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                  ...
                  <div>
                    <div style={{ fontSize: '1rem', fontWeight: 'bold', color: '#fff', lineHeight: 1 }}>{item.cost}</div>
      ...
      {showInventory && (
        <div style={{ 
          ...
          <div style={{ 
            width: '90%', maxWidth: '600px', background: '#0a0a0a', 
