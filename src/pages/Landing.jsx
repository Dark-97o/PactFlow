  ...
  return (
    <div className="vibrant-bg" style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
        ...
        <div>
                ...
                <div style={{ display: 'grid', gap: '12px' }}>
                  {wallets.map((w) => (
                    ...
                    >
                      ...
                      <span style={{ fontWeight: 'bold', fontSize: '0.9rem', color: '#fff' }}>{w.name}</span>
                    </button>
                  ))}
                </div>
              </div>
          ...
          {isAuthOpen && (
            <div className="modal-overlay" style={{ zIndex: 2000 }}>
              <div className="modal-content luxury-panel" style={{ 
                ...
                <div style={{ 
                  position: 'relative', 
                  background: 'linear-gradient(rgba(5, 5, 5, 0.4), rgba(5, 5, 5, 0.8)), url("/assets/img/login.jpg")', 
                  ...
                  <div style={{ position: 'relative', zIndex: 2 }}>
                    <h2 style={{ fontSize: '2.5rem', fontWeight: '900', color: '#fff', textTransform: 'uppercase', lineHeight: '1', marginBottom: '15px' }}>
                      Welcome to <br /><span style={{ color: 'var(--primary)' }}>PactFlow</span>
                    </h2>
                    <p style={{ color: 'var(--text-dim)', fontSize: '0.85rem', maxWidth: '300px', lineHeight: '1.4' }}>
          ...
          {isFeedbackOpen && (
            <div className="modal-overlay" style={{ zIndex: 3000 }}>
              <div className="modal-content luxury-panel" style={{ 
                ...
                <div style={{ 
                  background: 'linear-gradient(rgba(5, 5, 5, 0.3), rgba(5, 5, 5, 0.7)), url("/assets/img/feedback.jpg")', 
                  backgroundSize: 'cover',
                  backgroundPosition: 'center',
                  padding: '40px',
                  display: 'flex',
                  ...
                  <h2 style={{ fontSize: '2rem', fontWeight: '900', color: '#fff', textTransform: 'uppercase', lineHeight: '1.1' }}>
                    Improve <br /><span style={{ color: 'var(--primary)' }}>PactFlow</span>
                  </h2>
                </div>
          ...
          <header style={{
            ...
            <div style={{
              ...
              width: '100%',
              height: '100%',
              background: 'linear-gradient(to right, rgba(5, 5, 5, 1) 30%, rgba(5, 5, 5, 0) 100%)',
              zIndex: -1
            }}></div>
                ...
                {[...Array(2)].map((_, i) => (
                  <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '60px', paddingRight: '60px' }}>
                    {[
                      ...
                      <div key={idx} style={{ display: 'flex', alignItems: 'center', opacity: 0.7, filter: 'brightness(0) invert(1)', transition: 'all 0.3s' }} onMouseOver={e => { e.currentTarget.style.opacity = 1; e.currentTarget.style.filter = 'none'; }} onMouseOut={e => { e.currentTarget.style.opacity = 0.7; e.currentTarget.style.filter = 'brightness(0) invert(1)'; }}>
      ...
      <section className="animated-section-wrapper" style={{ 
        padding: '80px 20px 0', 
        backgroundImage: 'linear-gradient(rgba(5, 5, 5, 0.9), rgba(5, 5, 5, 0.9)), url("/assets/img/cyber_bg_v2.png")',
        backgroundSize: 'cover',
        backgroundPosition: 'center',
        ...
        <div id="lifecycle" style={{ marginTop: '100px', marginBottom: '120px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: '20px', marginTop: '30px' }}>
              <button 
                ...
                style={{ 
                  ...
                  border: '1px solid var(--primary)', 
                  color: onboardingRole === 'worker' ? '#000' : 'var(--primary)',
                  fontWeight: 'bold',
                  textTransform: 'uppercase',
                  letterSpacing: '2px',
                  cursor: 'pointer',
              ...
              <button 
                ...
                style={{ 
                  ...
                  border: '1px solid var(--primary)', 
                  color: onboardingRole === 'company' ? '#000' : 'var(--primary)',
                  fontWeight: 'bold',
                  textTransform: 'uppercase',
                  letterSpacing: '2px',
                  cursor: 'pointer',
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '20px', position: 'relative' }}>
            ...
            {(onboardingRole === 'worker' ? [
              ...
              { icon: <Star size={24} />, title: '05. PRESTIGE', desc: 'Acquire NFTs to unlock higher RPT tiers and elite missions.' }
            ] : [
              ...
              { icon: <ShoppingBag size={24} />, title: '05. MARKET', desc: 'Leverage capital in the NFT shop for brand authority artifacts.' }
            ]).map((step, i) => (
              <div key={i} className="cyber-card" style={{ 
                ...
                <h3 style={{ fontSize: '0.8rem', color: '#fff', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '10px' }}>{step.title}</h3>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                {[
                  ...
                  <div key={i} className="cyber-card">
                    ...
                    <h3 style={{ textTransform: 'uppercase', marginBottom: '10px', color: '#fff', fontSize: '0.8rem' }}>{step.title}</h3>
