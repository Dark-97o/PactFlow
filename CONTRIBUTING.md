# Contributing to PactFlow

First off, thank you for considering contributing to PactFlow! It's people like you that make the protocol secure, robust, and accessible to everyone on the Stellar Network. 
...
3. Provide a clear use-case and explain how it benefits the PactFlow ecosystem (Workers, Companies, or Admins).
...
PactFlow uses a specific "Vault-Tec / Dystopian" aesthetic. When adding new components:
